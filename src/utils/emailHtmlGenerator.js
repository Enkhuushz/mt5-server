        ...
        <div style="max-width: 600px; margin: 0 auto" class="email-container">
          ...
          >
            ...
            <p> Сайн байна уу ? 
              <br />
              <br />
              Танд энэ өдрийн мэнд хүргье. Таны ${dateFrom} - ${dateTo}-ны бүтээгдэхүүн, үйлчилгээний шимтгэл, хураамжийн и-баримтыг илгээж байна.
                <br />
                <br />
                ...
                <br />
                <hr style="border-style: dotted; border-color: black; border-width: 1px;">
                <table width="98%" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="text-align: left; width: 50%">
                      <span class="label" style="font-size: 14px"
                ...
                <table width="98%" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                      <td style="text-align: left; width: 50%">
                        <span class="label" style="font-size: 14px"
                          >Ebarimt.mn сайтад бүртгүүлэх дүн:</span
                        >
                      </td>
                      <td style="text-align: right; width: 50%">
                        <span
